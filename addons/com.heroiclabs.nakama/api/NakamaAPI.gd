...
class ApiClient extends Reference:
	...
	func authenticate_custom_async(
		...
		if p_username != null:
			query_params += "username=%s&" % p_username.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "POST"
		var headers = {}
	...
	func list_channel_messages_async(
		...
		urlpath = urlpath.replace("{channel_id}", p_channel_id.http_escape())
		var query_params = ""
		if p_limit != null:
		...
		if p_cursor != null:
			query_params += "cursor=%s&" % p_cursor.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "GET"
		var headers = {}
		var header = "Bearer %s" % p_bearer_token
	...
	func list_groups_async(
		...
		var query_params = ""
		if p_name != null:
			query_params += "name=%s&" % p_name.http_escape()
		if p_cursor != null:
			query_params += "cursor=%s&" % p_cursor.http_escape()
		if p_limit != null:
			query_params += "limit=%d&" % p_limit
	...
	func delete_group_async(
		...
		urlpath = urlpath.replace("{group_id}", p_group_id.http_escape())
		var query_params = ""
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "DELETE"
		var headers = {}
	...
	func delete_leaderboard_record_async(
		...
		urlpath = urlpath.replace("{leaderboard_id}", p_leaderboard_id.http_escape())
		var query_params = ""
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "DELETE"
		var headers = {}
	...
	func list_leaderboard_records_async(
		...
		if p_cursor != null:
			query_params += "cursor=%s&" % p_cursor.http_escape()
		if p_expiry != null:
			query_params += "expiry=%s&" % p_expiry.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "GET"
		var headers = {}
		var header = "Bearer %s" % p_bearer_token
	...
	func list_leaderboard_records_around_owner_async(
		...
		urlpath = urlpath.replace("{leaderboard_id}", p_leaderboard_id.http_escape())
		urlpath = urlpath.replace("{owner_id}", p_owner_id.http_escape())
		var query_params = ""
		if p_limit != null:
			query_params += "limit=%d&" % p_limit
		if p_expiry != null:
	...
	func list_matches_async(
		...
		if p_label != null:
			query_params += "label=%s&" % p_label.http_escape()
		if p_min_size != null:
			query_params += "min_size=%d&" % p_min_size
		if p_max_size != null:
			query_params += "max_size=%d&" % p_max_size
		if p_query != null:
			query_params += "query=%s&" % p_query.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "GET"
		var headers = {}
		var header = "Bearer %s" % p_bearer_token
	...
	func list_notifications_async(
		...
		if p_cacheable_cursor != null:
			query_params += "cacheable_cursor=%s&" % p_cacheable_cursor.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "GET"
		var headers = {}
		var header = "Bearer %s" % p_bearer_token
	...
	func rpc_func2_async(
		...
		urlpath = urlpath.replace("{id}", p_id.http_escape())
		var query_params = ""
		if p_payload != null:
			query_params += "payload=%s&" % p_payload.http_escape()
		if p_http_key != null:
			query_params += "http_key=%s&" % p_http_key.http_escape()
		var uri = "%s%s%s" % [_base_uri, urlpath, "?" + query_params if query_params else ""]
		var method = "GET"
		var headers = {}
		if (p_bearer_token):
	...
	func list_storage_objects_async(
		...
		urlpath = urlpath.replace("{collection}", p_collection.http_escape())
		var query_params = ""
		if p_user_id != null:
			query_params += "user_id=%s&" % p_user_id.http_escape()
		if p_limit != null:
			query_params += "limit=%d&" % p_limit
		if p_cursor != null:
			query_params += "cursor=%s&" % p_cursor.http_escape()
	...
	func list_storage_objects2_async(
		...
		urlpath = urlpath.replace("{collection}", p_collection.http_escape())
		urlpath = urlpath.replace("{user_id}", p_user_id.http_escape())
		var query_params = ""
		if p_limit != null:
			query_params += "limit=%d&" % p_limit
		if p_cursor != null:
	...
	func list_tournament_records_async(
		...
		urlpath = urlpath.replace("{tournament_id}", p_tournament_id.http_escape())
		var query_params = ""
		if p_owner_ids != null:
			for elem in p_owner_ids:
				query_params += "owner_ids=%s&" % elem
