...
## Initializes a new instance of the SatoriSession class. [br]
## p_token - The authentication token. [br]
## p_refresh_token - The refresh token. [br]
## p_exception - The exception to be thrown, if any. [br]
